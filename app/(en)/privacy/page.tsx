...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Privacy', description: 'How Advanced Fifth Axis handles the information you share when making an inquiry.', url: "https://advanced-fifthaxis.com/privacy" }
};
